...
const ModuleProductHasVariants = ({ ecomerce, currency, product }) => {
    ...
    function handleAddItemToCart(e) {
        e.preventDefault();
        addItem(
            { id: product.uuid, quantity: quantity },
            ecomerce.cartItems,
            'cart'
        );
    }
    ...
    const handleAddItemToCompare = (e) => {
        e.preventDefault();
        e.preventDefault();
        addItem({ id: product.uuid }, ecomerce.compareItems, 'compare');
    ...
    const handleAddItemToWishlist = (e) => {
        e.preventDefault();
        addItem({ id: product.uuid }, ecomerce.wishlistItems, 'wishlist');
        const modal = Modal.success({
            centered: true,
            title: 'Success!',
