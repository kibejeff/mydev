...
export default function Register() {
	...
	}, [confirmPassword, password, phoneNo, phoneNoErr])
					...
					className='mt-5'>
						...
						>
							...
							<div
								style={{
									display: 'flex',
									flexDirection: isMobile || isTabletOrMobile ? 'column' : 'row',
									justifyContent: isMobile || isTabletOrMobile ?'justify-center' : 'space-between',
								}}
							>
								...
								<Input.Group>
									...
									rules={[
										...
										<Input onChange={handlePhone} value={phoneNo} type='tel' style={{
												width: '300px',
											}} size='large' />
									</Form.Item>
									...
									rules={[
										...
										<Input.Password value={password} onChange={e => setpassword(e.target.value)} required style={{
												width: '300px',
											}} size='large' visibilityToggle={true} />
									</Form.Item>
									...
									rules={[
										...
										<Input.Password value={confirmPassword} onChange={e => setconfirmPassword(e.target.value)} id='password-confirmation' style={{
												width: '300px',
											}} size='large' />
									</Form.Item>
								</Input.Group>
