					...
					<div className='ps-about-awards'>
						<div className='container'>
							<div className='ps-section__header'>
								...
								<p>
									Industry leaders and influencers recognize Overstock as one of
									the most trust worthy retail companies in the U.S., ranking
									high for both customer and employee satisfaction.
								</p>
							</div>
