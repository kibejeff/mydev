					...
					<div className='ps-block--vendor'>
						...
						<div className='ps-block__container'>
							...
							<div className='ps-block__content'>
								<p>
									<strong>Digiworld US</strong>, New York’s no.1 online retailer
									was established in May 2012 with the aim and vision to become
									the one-stop shop for retail in New York with implementation
