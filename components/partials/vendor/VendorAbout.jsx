	...
	<div className='ps-section--vendor ps-vendor-about'>
		<div className='container'>
			<div className='ps-section__header'>
				<p>WHY SELL ON POWERPAY AFRICA</p>
				<h4>
					Join a marketplace where nearly 50 million buyers around <br /> the
					world shop for unique items
				</h4>
			</div>
							...
							<div className='ps-block__content'>
								...
								<div className='ps-block__desc' data-mh='about-desc'>
									<p>
										...
										sale, powerpay-africa’s transaction fee is just 2.5%.
									</p>
								</div>
								<a href='#'>Learn more</a>
							</div>
