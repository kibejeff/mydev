	...
	<div className='ps-section--vendor ps-vendor-best-fees'>
		<div className='container'>
			...
			<div className='ps-section__content'>
				<h5>
					It doesn’t cost a thing to list up to 50 items a month, and you only
					pay after your stuff sells. It’s just a small percent of the money you
					earn
				</h5>
				...
				<div className='ps-section__highlight'>
					<img src='/static/img/icons/vendor-4.png' alt='powerpay-africa' />
					<figure>
						<p>
							...
							methods. Funds from PayPal sales on powerpay-africa will be
