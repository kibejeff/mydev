...
class LanguageSwicher extends Component {
    ...
    handleFeatureWillUpdate(e) {
        ...
        notification.open({
            ...
            description: 'This feature is still in development mode!',
            duration: 500,
        });
    }
        ...
        return (
					<div className='ps-dropdown language'>
						<a href='#' onClick={this.handleFeatureWillUpdate.bind(this)}>
							<img src='/static/img/flag/en.png' alt='powerpay-africa' />
							English
						</a>
						<ul className='ps-dropdown-menu'>
							...
							<li>
								<a href='#' onClick={this.handleFeatureWillUpdate.bind(this)}>
									<img src='/static/img/flag/fr.png' alt='powerpay-africa' />
									France
								</a>
							</li>
						</ul>
